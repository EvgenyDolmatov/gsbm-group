...
class EmailController extends Controller
{
    public function mailFeedbackData(Request $request)
    {
        ...
        // info@gsbm-group.ru
        Mail::to('evd.work@yandex.ru')->send(new FeedbackMail($customer));
    ...
    public function mailFeedbackConsultData(Request $request)
    {
        ...
        // info@gsbm-group.ru
        Mail::to('evd.work@yandex.ru')->send(new FeedbackConsultMail($customer));
    ...
    public function mailFeedbackPartnerData(Request $request)
    {
        ...
        // info@gsbm-group.ru
        Mail::to('evd.work@yandex.ru')->send(new FeedbackPartnerMail($customer));
