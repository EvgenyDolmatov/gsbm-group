    ...
    */
    ...
    'custom' => [
        'surname' => [
            ...
            'max' => [
                'string' => 'Фамилия не может быть длиннее :max символов.',
            ],
        ],
        'name' => [
        ...
        'password' => [
            ...
            'min' => [
                'string' => 'Минимальная длина пароля - 8 символов.'
            ]
        ],
        'current_password' => [
        ...
        'privacy_policy' => [
            'required' => 'Вам нужно согласиться с политикой безопасности.'
        ],
        // Courses
        'study_area_id' => [
        ...
        'price' => [
            'required' => 'Укажите стоимость курса'
        ],
        'question_text' => [
