                        ...
                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                                <td align="center" class="px-sm-16" style="padding: 0 96px;">
                                    <h1 class="webfont h1" style="color: #FFFFFF; font-size: 36px; font-weight: 300; line-height: 100%; margin: 0;">Подтвердите свой E-mail адрес</h1>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                                <td class="col px-sm-16" align="center" width="100%" style="padding: 0 64px;">
                                    ...
                                    <p style="color: #888888; font-size: 16px; line-height: 24px; margin: 0;">Для доступа ко всем функциям сайта, Вам необходимо подтвердить свою E-mail.</p>
                                    ...
                                    <table cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            <td class="webfont hover-scale" bgcolor="#7ABA29" style="border-radius: 3px; transition: all 0.3s ease-in-out 0s; mso-padding-alt: 6px 32px 12px;">
                                                <a href="{{$url}}" style="background-color:#0c63e4;color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 700; padding: 12px 32px; text-decoration: none;">Подтвердить E-mail</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
