                        ...
                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                                <td align="center" class="px-sm-16" style="padding: 0 96px;">
                                    <h1 class="webfont h1" style="color: #FFFFFF; font-size: 36px; font-weight: 300; line-height: 100%; margin: 0;">Новое резюме</h1>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                                <td class="col px-sm-16" align="center" width="100%" style="padding: 0 64px;">
                                    <h2 style="color: #000; font-size: 20px; font-weight: 300; line-height: 28px; margin: 0 0 24px;">Вам отправили новое резюме.</h2>
                                    <p style="color: #888888; font-size: 16px; line-height: 24px; margin: 0;">Имя: {{$employeeRequest->name}}</p>
                                    <p style="color: #888888; font-size: 16px; line-height: 24px; margin: 0;">Телефон: {{$employeeRequest->phone}}</p>
                                    <p style="color: #888888; font-size: 16px; line-height: 24px; margin: 0;">Email: {{$employeeRequest->email}}</p>
