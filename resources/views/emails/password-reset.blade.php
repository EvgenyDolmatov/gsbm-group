                        ...
                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                                <td align="center" class="px-sm-16" style="padding: 0 96px;">
                                    <h1 class="webfont h1" style="color: #FFFFFF; font-size: 36px; font-weight: 300; line-height: 100%; margin: 0;">Сброс пароля</h1>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                                <td class="col px-sm-16" align="center" width="100%" style="padding: 0 64px;">
                                    <h2 style="color: #000; font-size: 20px; font-weight: 300; line-height: 28px; margin: 0 0 24px;">Здравствуйте!</h2>
                                    <p style="color: #888888; font-size: 16px; line-height: 24px; margin: 0;">Мы получили запрос на сброс Вашего пароля. Нажмите на кнопку ниже для перехода к процессу восстановления пароля.</p>
                                    ...
                                    <table cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            <td class="webfont hover-scale" bgcolor="#7ABA29" style="border-radius: 3px; transition: all 0.3s ease-in-out 0s; mso-padding-alt: 6px 32px 12px;">
                                                <a href="{{$url}}" style="color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 700; padding: 12px 32px; text-decoration: none;">Сбросить пароль</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
