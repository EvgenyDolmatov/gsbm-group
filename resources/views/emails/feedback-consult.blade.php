                        ...
                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                                <td class="col" align="center" width="100%">
                                    <a href="{{URL::to('/')}}">
                                        <img src="https://gsbm-group.ru/assets/app/img/logo.svg" alt="Header Logo" width="100">
                                    </a>
                                </td>
                            </tr>
                        </table>
...
<table class="wrapper" cellpadding="0" cellspacing="0" role="presentation" width="100%">
    <tr>
        <td align="center" bgcolor="#EEEEEE" class="px-sm-16">
            <table class="container" cellpadding="0" cellspacing="0" role="presentation" width="600">
                <tr>
                    <td bgcolor="#0072FF" style="background: radial-gradient(circle at bottom, #4880c9, #0c63e4);">
                        ...
                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                                <td align="center" class="px-sm-16" style="padding: 0 96px;">
                                    <h1 class="webfont h1" style="color: #FFFFFF; font-size: 36px; font-weight: 300; line-height: 100%; margin: 0;">Новая заявка</h1>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                                <td class="col px-sm-16" align="center" width="100%" style="padding: 0 64px;">
                                    <h2 style="color: #000; font-size: 20px; font-weight: 300; line-height: 28px; margin: 0 0 24px;">Запрос заявки на консультацию.</h2>
                                    <p style="color: #888888; font-size: 16px; line-height: 24px; margin: 0;">Имя: {{$customer['name']}}</p>
                                    <p style="color: #888888; font-size: 16px; line-height: 24px; margin: 0;">Телефон: {{$customer['phone']}}</p>
                                    <p style="color: #888888; font-size: 16px; line-height: 24px; margin: 0;">Email: {{$customer['email']}}</p>
                                    <p style="color: #888888; font-size: 16px; line-height: 24px; margin: 0;">Сообщение: {{$customer['comment']}}</p>
                            ...
                            <tr>
                                <td class="col" align="center" width="100%" style="padding: 0 8px;">
                                    ...
                                    <p style="color: #888888; margin: 0;">
                                        &copy; 2022 ООО "Геострой-Буммаш". Все права защищены.
                                    </p>
                                    <div class="spacer line-height-sm-0 py-sm-8" style="line-height: 24px;">&zwnj;</div>
                    ...
                    <td class="px-sm-8" bgcolor="#EEEEEE" style="padding: 0 24px;">
                        ...
                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                                <td class="col" align="center" width="100%" style="padding: 0 8px;">
                                    <p style="color: #888888; margin: 0;">
                                        Остались вопросы? Напишите на наш e-mail <a href="https://example.com" style="color: #888888; text-decoration: underline;">support@geostroy.com</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
